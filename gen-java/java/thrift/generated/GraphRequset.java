...
public class GraphRequset implements org.apache.thrift.TBase<GraphRequset, GraphRequset._Fields>, java.io.Serializable, Cloneable, Comparable<GraphRequset> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> herbs; // required
  ...
  public GraphRequset(
    java.util.List<java.lang.String> herbs)
  {
    this();
    this.herbs = herbs;
  }
  ...
  public GraphRequset(GraphRequset other) {
    if (other.isSetHerbs()) {
      java.util.List<java.lang.String> __this__herbs = new java.util.ArrayList<java.lang.String>(other.herbs);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getHerbsIterator() {
    return (this.herbs == null) ? null : this.herbs.iterator();
  }

  public void addToHerbs(java.lang.String elem) {
    if (this.herbs == null) {
      this.herbs = new java.util.ArrayList<java.lang.String>();
    }
    this.herbs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.String> getHerbs() {
    return this.herbs;
  }

  public GraphRequset setHerbs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> herbs) {
    this.herbs = herbs;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case HERBS:
      if (value == null) {
        ...
        setHerbs((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(GraphRequset other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHerbs(), other.isSetHerbs());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GraphRequset(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.herbs = new java.util.ArrayList<java.lang.String>(_list16.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GraphRequset struct) throws org.apache.thrift.TException {
      ...
      if (struct.herbs != null) {
        oprot.writeFieldBegin(HERBS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter19 : struct.herbs)
          {
      ...
      if (struct.isSetHerbs()) {
        {
          ...
          for (java.lang.String _iter20 : struct.herbs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.herbs = new java.util.ArrayList<java.lang.String>(_list21.size);
