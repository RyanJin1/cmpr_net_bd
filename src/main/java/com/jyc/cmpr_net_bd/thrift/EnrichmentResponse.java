            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new java.util.ArrayList<EnrichmentReusltItem>(_list72.size);
                @org.apache.thrift.annotation.Nullable EnrichmentReusltItem _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new EnrichmentReusltItem();
                  _elem73.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EnrichmentResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (EnrichmentReusltItem _iter75 : struct.result)
          {
            _iter75.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (EnrichmentReusltItem _iter76 : struct.result)
          {
            _iter76.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.result = new java.util.ArrayList<EnrichmentReusltItem>(_list77.size);
          @org.apache.thrift.annotation.Nullable EnrichmentReusltItem _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new EnrichmentReusltItem();
            _elem78.read(iprot);
