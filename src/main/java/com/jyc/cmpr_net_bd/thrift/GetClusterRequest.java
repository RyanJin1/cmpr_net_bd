            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.targets = new java.util.ArrayList<String>(_list32.size);
                @org.apache.thrift.annotation.Nullable String _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = iprot.readString();
                  struct.targets.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetClusterRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.targets != null) {
        oprot.writeFieldBegin(TARGETS_FIELD_DESC);
        {
          ...
          for (String _iter35 : struct.targets)
          {
      ...
      if (struct.isSetTargets()) {
        {
          ...
          for (String _iter36 : struct.targets)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.targets = new java.util.ArrayList<String>(_list37.size);
          @org.apache.thrift.annotation.Nullable String _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = iprot.readString();
            struct.targets.add(_elem38);
          }
        }
        struct.setTargetsIsSet(true);
      }
