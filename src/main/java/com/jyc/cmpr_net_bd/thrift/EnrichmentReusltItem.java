            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.genes = new java.util.ArrayList<String>(_list64.size);
                @org.apache.thrift.annotation.Nullable String _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = iprot.readString();
                  struct.genes.add(_elem65);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EnrichmentReusltItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.genes != null) {
        oprot.writeFieldBegin(GENES_FIELD_DESC);
        {
          ...
          for (String _iter67 : struct.genes)
          {
      ...
      if (struct.isSetGenes()) {
        {
          ...
          for (String _iter68 : struct.genes)
          {
