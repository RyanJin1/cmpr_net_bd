...
public class GraphResponse implements org.apache.thrift.TBase<GraphResponse, GraphResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GraphResponse> {
  ...
  public GraphResponse setCode(@org.apache.thrift.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public GraphResponse setMsg(@org.apache.thrift.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GraphResponse(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rel = new java.util.ArrayList<RelItem>(_list16.size);
                @org.apache.thrift.annotation.Nullable RelItem _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new RelItem();
                  _elem17.read(iprot);
                  struct.rel.add(_elem17);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.node = new java.util.ArrayList<PosItem>(_list19.size);
                @org.apache.thrift.annotation.Nullable PosItem _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = new PosItem();
                  _elem20.read(iprot);
                  struct.node.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GraphResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.rel != null) {
        oprot.writeFieldBegin(REL_FIELD_DESC);
        {
          ...
          for (RelItem _iter22 : struct.rel)
          {
            _iter22.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.node != null) {
        oprot.writeFieldBegin(NODE_FIELD_DESC);
        {
          ...
          for (PosItem _iter23 : struct.node)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetRel()) {
        {
          ...
          for (RelItem _iter24 : struct.rel)
          {
            _iter24.write(oprot);
          }
        }
      ...
      if (struct.isSetNode()) {
        {
          ...
          for (PosItem _iter25 : struct.node)
          {
            _iter25.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.rel = new java.util.ArrayList<RelItem>(_list26.size);
          @org.apache.thrift.annotation.Nullable RelItem _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            _elem27 = new RelItem();
            _elem27.read(iprot);
            struct.rel.add(_elem27);
          }
        }
        struct.setRelIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.node = new java.util.ArrayList<PosItem>(_list29.size);
          @org.apache.thrift.annotation.Nullable PosItem _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new PosItem();
            _elem30.read(iprot);
            struct.node.add(_elem30);
          }
        }
        struct.setNodeIsSet(true);
      }
