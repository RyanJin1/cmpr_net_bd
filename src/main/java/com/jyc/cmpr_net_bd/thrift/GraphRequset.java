            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.herbs = new java.util.ArrayList<String>(_list8.size);
                @org.apache.thrift.annotation.Nullable String _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = iprot.readString();
                  struct.herbs.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GraphRequset struct) throws org.apache.thrift.TException {
      ...
      if (struct.herbs != null) {
        oprot.writeFieldBegin(HERBS_FIELD_DESC);
        {
          ...
          for (String _iter11 : struct.herbs)
          {
      ...
      if (struct.isSetHerbs()) {
        {
          ...
          for (String _iter12 : struct.herbs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.herbs = new java.util.ArrayList<String>(_list13.size);
          @org.apache.thrift.annotation.Nullable String _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readString();
            struct.herbs.add(_elem14);
          }
        }
        struct.setHerbsIsSet(true);
      }
